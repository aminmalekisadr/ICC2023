...
class Preprocess:
    ...
    def load_dataset(self, dataset_path):
        ...
        self.dataset = pd.read_csv(os.getcwd() + dataset_path, parse_dates=False)
        ...
        train_x_lr_st = np.reshape(train_x_lr, (train_x_lr.shape[0], train_x_lr.shape[1]))
        test_x_lr_st = np.reshape(test_x_lr, (test_x_lr.shape[0], test_x_lr.shape[1]))

        return self.dataset, scaler, train_x_stf, train_x_st, train_y, test_x_stf, test_x_st, test_y, train_x_rf_stf, train_x_rf, train_y_rf, test_x_rf_stf, test_x_rf, test_y_rf, train_x_rf_st, test_x_rf_st, train_x_lr_st, train_x_lr, train_y_lr, test_x_lr_st, test_x_lr, test_y_lr
